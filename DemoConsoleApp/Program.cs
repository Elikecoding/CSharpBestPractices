    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            finally
            {
                ...
                log4net.GlobalContext.Properties["Counter"] = c;

                for (c.LoopCounter = 0; c.LoopCounter < 1; c.LoopCounter++)
                {
                    log.Fatal("Fatal");
                }
        ...
        private static void TeachMeArrays()
        {
            ...
            try
            {
                ...
                Console.WriteLine(" The item at Index 3 is : " + numArray[2]);
                Console.WriteLine(" The item at Index 5 is : " + numArray[4]);
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException("Something went wrong with your Array :(", ex);
            }
            finally
            {
        ...
        private static void CreateMyStack()
        {
            ...
            {
                throw new ArgumentException("Something has gone wrong with your stack", ex);
            }
            finally
            {
        ...
        private static void CreateMyQueue()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException("Please check your queue", ex);
            }
            finally
            {
        ...
        private static void CreateMyDictionary()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException("Please check your dictionary", ex);
            }
            finally
            {
        ...
        private static void DothisIf()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException("Please check your if statement", ex);
            }
        }
        ...
        private static void DoThisElse()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException("Please check your if-else statement", ex);
            }
        }
        ...
        private static void DoThisElseIfElse()
        {
            ...
            {
                throw new ArgumentException("Please check your statement", ex);
            }
        }
        ...
        private static void CreateCaseSwitch()
        {
            ...
            {
                throw new ArgumentException("Please check your case-switch statement", ex);
            }
        ...
        private static void CreateAForLoop()
        {
            ...
            {
                throw new ArgumentException("Please check your for-loop", ex);
            }
        ...
        private static void CreateAWhileLoop()
        {
            ...
            {
                throw new ArgumentException("Please check your while-loop", ex);
            }
        }
        ...
        private static void CreateADoWhileLoop()
        {
            ...
            {
                throw new ArgumentException("Please check your do-while loop", ex);
            }
        }
        ...
        private static void TeachMeTernarys()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException("Please check your Ternary", ex);
            }
